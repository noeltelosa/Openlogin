  ...
  (function() {
    return window.Lync = (function() {
      ...
      Lync.prototype.OnStatusChange = function(name, status, id) {
        ...
        that = this;
        tags = void 0;
        tags = jQuery(".author").filter(function() {
          return jQuery(this).attr("data-user-id") === name;
        });
        tags.each(function() {
          Lync.SetImageClassStatus(jQuery(this), status);
      ...
      Lync.ShowLyncPresencePopup = function(target) {
        ...
        x = void 0;
        y = void 0;
        userName = jQuery(target).attr("data-user-id");
        if (!nameCtrl) {
          return;
        }
        eLeft = jQuery(target).offset().left;
        x = eLeft - jQuery(window).scrollLeft();
        eTop = jQuery(target).offset().top;
        y = eTop - jQuery(window).scrollTop();
      ...
      Lync.prototype.InsertLyncs = function() {
        var that;
        that = this;
        jQuery('.author').each(function(index, item) {
          that.InsertLync(jQuery(item));
        });
      };
